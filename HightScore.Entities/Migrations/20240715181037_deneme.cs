    ...
    public partial class deneme : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "d4a7ff6f-2000-44ea-8b82-9c191c2f87c1", "MetaUser", "admin@example.com", true, false, null, "ADMIN@EXAMPLE.COM", "ADMIN", "AQAAAAEAACcQAAAAEFj6FZQ6ew2o4PjB5HbjZc2P6A0EHkD3OXizZrj0LxG8B8el1omRZcU/lY8qdJWpWw==", null, false, "JZTQQKJ3CQCXYN4AWFLARBLI4NXY2FYW", false, "admin" });
            ...
            migrationBuilder.InsertData(
                table: "Items",
                columns: new[] { "Id", "Description", "MediaAverageRating", "RelaseDate", "Title", "UpdatedAt", "UserAverageRating" },
                values: new object[,]
                {
                    { 1, "An action-adventure game developed and published by Nintendo.", 9.8m, new DateTime(2017, 3, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "The Legend of Zelda: Breath of the Wild", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4147), 9.5m },
                    { 2, "A platform game developed and published by Nintendo for the Nintendo Switch.", 9.7m, new DateTime(2017, 10, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), "Super Mario Odyssey", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4164), 9.3m },
                    { 3, "An action-adventure game developed and published by Rockstar Games.", 9.8m, new DateTime(2018, 10, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "Red Dead Redemption 2", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4167), 9.6m },
                    { 4, "An action-adventure game developed by Santa Monica Studio and published by Sony Interactive Entertainment.", 9.6m, new DateTime(2018, 4, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "God of War", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4170), 9.4m },
                    { 5, "An action role-playing game developed and published by CD Projekt.", 9.9m, new DateTime(2015, 5, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "The Witcher 3: Wild Hunt", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4172), 9.7m },
                    { 6, "An action role-playing game developed and published by CD Projekt.", 8.9m, new DateTime(2020, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Cyberpunk 2077", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4176), 8.5m },
                    { 7, "A sandbox video game developed by Mojang.", 9.5m, new DateTime(2011, 11, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "Minecraft", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4179), 9.2m },
                    { 8, "An online video game developed by Epic Games.", 9.0m, new DateTime(2017, 7, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Fortnite", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4181), 8.8m },
                    { 9, "An action role-playing game developed by Bethesda Game Studios and published by Bethesda Softworks.", 9.7m, new DateTime(2011, 11, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "The Elder Scrolls V: Skyrim", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4185), 9.4m },
                    { 10, "An action role-playing game developed by Guerrilla Games and published by Sony Interactive Entertainment.", 9.5m, new DateTime(2017, 2, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Horizon Zero Dawn", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4188), 9.3m },
                    { 11, "An action role-playing game developed and published by Square Enix.", 8.8m, new DateTime(2016, 11, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "Final Fantasy XV", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4190), 8.6m },
                    { 12, "A role-playing video game developed by Atlus.", 9.6m, new DateTime(2016, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Persona 5", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4193), 9.5m },
                    { 13, "An action role-playing game developed by FromSoftware and published by Bandai Namco Entertainment.", 9.3m, new DateTime(2016, 3, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Dark Souls III", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4195), 9.1m },
                    { 14, "An action role-playing game developed by FromSoftware and published by Sony Computer Entertainment.", 9.4m, new DateTime(2015, 3, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bloodborne", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4202), 9.3m },
                    { 15, "A team-based multiplayer first-person shooter developed and published by Blizzard Entertainment.", 9.1m, new DateTime(2016, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Overwatch", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4204), 8.9m },
                    { 16, "An action-adventure game developed by FromSoftware and published by Activision.", 9.5m, new DateTime(2019, 3, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sekiro: Shadows Die Twice", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4207), 9.2m },
                    { 17, "An action role-playing game developed by Team Ninja and published by Koei Tecmo.", 8.9m, new DateTime(2017, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "Nioh", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4209), 8.7m },
                    { 18, "An action role-playing game developed and published by Capcom.", 9.2m, new DateTime(2018, 1, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "Monster Hunter: World", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4211), 9.0m },
                    { 19, "A survival horror game developed and published by Capcom.", 9.5m, new DateTime(2019, 1, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Resident Evil 2", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4213), 9.3m },
                    { 20, "An action-adventure game developed by Sucker Punch Productions and published by Sony Interactive Entertainment.", 9.5m, new DateTime(2020, 7, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ghost of Tsushima", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4216), 9.4m },
                    { 21, "An action role-playing video game developed by Ubisoft Montreal and published by Ubisoft.", 9.0m, new DateTime(2020, 11, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Assassin's Creed Valhalla", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4218), 8.8m },
                    { 22, "An action-adventure game developed by Naughty Dog and published by Sony Interactive Entertainment.", 9.8m, new DateTime(2020, 6, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "The Last of Us Part II", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4233), 9.6m },
                    { 23, "An action-adventure game developed by Remedy Entertainment and published by 505 Games.", 9.1m, new DateTime(2019, 8, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), "Control", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4236), 8.9m },
                    { 24, "A roguelike action dungeon crawler video game developed and published by Supergiant Games.", 9.7m, new DateTime(2020, 9, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hades", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4238), 9.5m },
                    { 25, "A first-person shooter game developed by id Software and published by Bethesda Softworks.", 9.3m, new DateTime(2020, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Doom Eternal", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4240), 9.1m },
                    { 26, "An action role-playing game developed and published by miHoYo.", 8.8m, new DateTime(2020, 9, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Genshin Impact", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4242), 8.6m },
                    { 27, "An action game developed by Kojima Productions and published by Sony Interactive Entertainment.", 8.9m, new DateTime(2019, 11, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "Death Stranding", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4244), 8.7m },
                    { 28, "An action-adventure game developed by Insomniac Games and published by Sony Interactive Entertainment.", 9.3m, new DateTime(2018, 9, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "Marvel's Spider-Man", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4246), 9.2m },
                    { 29, "A virtual reality first-person shooter developed and published by Valve.", 9.6m, new DateTime(2020, 3, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "Half-Life: Alyx", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4248), 9.4m },
                    { 30, "An action role-playing game developed and published by TaleWorlds Entertainment. Bannerlord is a prequel to Mount & Blade: Warband, a stand-alone expansion pack for the 2008 game Mount & Blade.", 8.7m, new DateTime(2020, 3, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Mount and Blade II: Bannerlord", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4250), 8.5m },
                    { 31, "Explore the depths of Arkham Asylum as Batman, unraveling a sinister plot orchestrated by his arch-nemesis, the Joker.", 9.2m, new DateTime(2009, 8, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Batman: Arkham Asylum", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4253), 9.0m },
                    { 32, "Gotham City is transformed into a sprawling prison, and Batman must navigate its dangerous streets to uncover a new threat.", 9.3m, new DateTime(2011, 10, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "Batman: Arkham City", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4255), 9.1m },
                    { 33, "The Dark Knight faces the ultimate threat to Gotham City as the Scarecrow unites Batman's foes to destroy him once and for all.", 9.0m, new DateTime(2015, 6, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "Batman: Arkham Knight", new DateTime(2024, 7, 15, 21, 10, 36, 769, DateTimeKind.Local).AddTicks(4257), 8.9m }
                });
